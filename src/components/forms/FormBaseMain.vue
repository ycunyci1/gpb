<template>
    <form id="basemain_form" @submit.prevent="saveForm">
        <div class="form__column">
            ...
            <input type="submit" class="button _full">
        </div>
    </form>
</template>
...
const saveForm = async () => {
    stateCheck();
    let form = document.getElementById("basemain_form");
    ...
    try {
        ...
        ym(95838644,'reachGoal','top_feedback_form_ok');
        state.name = '';
        state.phone = '';
        state.mail = '';
