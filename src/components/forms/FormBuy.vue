<template>
    <form id="buy_form" @submit.prevent="saveForm">
        <div class="form__column">
            <input type="hidden" name="credit" value="2">
            ...
            <input type="text" placeholder="Марка и модель" name="model" class="input input-styled" v-model="store.popups.buy.model">
            ...
            <textarea placeholder="Сообщение..." name="message" class="textarea input-styled textarea-styled"></textarea>
...
const saveForm = async () => {
    stateCheck();
    let form = document.getElementById("buy_form");
